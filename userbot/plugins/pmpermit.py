...
USER_BOT_NO_WARN = ("[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](tg://user?id=742506768)\n\n"
                    "`Hello, what are u doing here.Do i know you?,`"
                    f"{DEFAULTUSER}'s` inbox.\n\n"
                    "Leave your name, phone number, address and 10k$ and hopefully you'll get a reply if my master know you.`\n\n"
    ...
    async def approve_p_m(event):
        ...
        if event.is_private:
            if not pmpermit_sql.is_approved(chat.id):
                ...
                await event.edit("Approved Peru Nibba [{}](tg://user?id={})".format(firstname, chat.id))
